...
#Проверим выполнение равенства S2 = S2F + F2res 
...
T
5.500053450812598
#Зафиксируем уровень значимости α = 0.05. Для него найдём критическое значение F crit:
...
F_crit
3.3851899614491687
#Видим, что T > F crit' , поэтому заключаем, что отличие среднего роста футболистов, хокеистов и штангистов действительно является статистически значимым.
